...
这个项目不只是做功能，更在意“陪伴角色”长期待在桌面时，给人的感觉是不是舒服、自然、可信。所以一处改动是否成功，不只看它能不能运行，也看它会不会破坏角色的安静感、产品气质和长期使用体验。
...
当前内置基准角色是 **bb7**。如果你要改视觉、动画、陪伴内容或者产品语气，尽量以 bb7 现在的方向为基准，不要把项目带回旧式桌宠 demo 或普通聊天工具的感觉。
...
如果这次改动涉及 bb7 的动画、atlas 或 sprite 资源，再补一项：
...
- 对外文案尽量自然，不要写成客服话术或 AI 宣传稿

## 宠物包与社区扩展

如果你准备贡献宠物包或宠物包模板，先参考：
