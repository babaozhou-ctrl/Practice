...
import type { BuiltInPetPackage, PetAnimationConfig, PetAssetStatus, PetAppearanceProfile, PetPackageManifest, PetProductionProfile, PetStatesConfig } from '../../shared/types/petPackage'
